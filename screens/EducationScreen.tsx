...
import {
  ...
  ScrollView, StatusBar, Image, FlatList, Dimensions,
} from 'react-native';
      ...
      <ScrollView contentContainerStyle={st.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={st.section}>
          <View style={st.sectionHeader}>
            ...
            <TouchableOpacity onPress={onViewAllStress} activeOpacity={0.7}>
          ...
          <View style={st.stressGrid}>
            {/* Hero: Breathing */}
            <TouchableOpacity style={st.breathingCard} onPress={onStartBreathing} activeOpacity={0.85}>
              <View style={{ zIndex: 1 }}>
            ...
            <View style={st.stressRow}>
              <TouchableOpacity style={st.stressSmallCard} onPress={onJournal} activeOpacity={0.7}>
              ...
              <TouchableOpacity style={st.stressSmallCard} onPress={onMeditation} activeOpacity={0.7}>
        ...
        <View style={st.section}>
          <View style={st.sectionHeader}>
            ...
            <TouchableOpacity onPress={onViewAllHiv} activeOpacity={0.7}>
              <Text style={st.viewAll}>Lihat Semua</Text>
            </TouchableOpacity>
          </View>
          <FlatList data={ARTICLES} horizontal showsHorizontalScrollIndicator={false}
            ...
            renderItem={({ item }) => (
              <TouchableOpacity style={st.articleCard} onPress={() => onArticlePress?.(item.id)} activeOpacity={0.8}>
        ...
        <View style={st.section}>
          ...
          {/* Featured Video */}
          <TouchableOpacity style={st.featuredVideo} onPress={() => onVideoPress?.('featured')} activeOpacity={0.85}>
          ...
          <FlatList data={VIDEOS} horizontal showsHorizontalScrollIndicator={false}
            ...
            renderItem={({ item }) => (
              <TouchableOpacity style={st.smallVideoCard} onPress={() => onVideoPress?.(item.id)} activeOpacity={0.8}>
